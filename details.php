...
<div id="content"  style="margin-top: 50px;" ><!-- content Starts -->
...
<button class="btn btn-warning" type="" name="" onclick="window.open('VirtualStatic/index.php')">

<i class="fa fa-heart" ></i> Virtual-Try    
